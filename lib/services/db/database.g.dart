...
class FavoriteHospital extends DataClass
    implements Insertable<FavoriteHospital> {
  final int id;
  final String name;
  ...
  FavoriteHospital(
      ...
      required this.web});
  factory FavoriteHospital.fromData(Map<String, dynamic> data,
      {String? prefix}) {
    final effectivePrefix = prefix ?? '';
  ...
  FavoriteHospitalsCompanion toCompanion(bool nullToAbsent) {
    return FavoriteHospitalsCompanion(
      id: Value(id),
      name: Value(name),
  ...
  FavoriteHospital copyWith(
          {int? id, String? name, String? address, String? web}) =>
      FavoriteHospital(
        id: id ?? this.id,
        name: name ?? this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('FavoriteHospital(')
          ..write('id: $id, ')
          ..write('name: $name, ')
  ...
  @override
  int get hashCode => Object.hash(id, name, address, web);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is FavoriteHospital &&
          other.id == this.id &&
...
class FavoriteHospitalsCompanion extends UpdateCompanion<FavoriteHospital> {
  final Value<int> id;
  final Value<String> name;
  final Value<String> address;
  final Value<String> web;
  const FavoriteHospitalsCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
    this.address = const Value.absent(),
    this.web = const Value.absent(),
  });
  FavoriteHospitalsCompanion.insert({
    this.id = const Value.absent(),
    ...
    required String web,
        ...
        address = Value(address),
        web = Value(web);
  static Insertable<FavoriteHospital> custom({
    Expression<int>? id,
  ...
  FavoriteHospitalsCompanion copyWith(
      {Value<int>? id,
      Value<String>? name,
  ...
  @override
  String toString() {
    return (StringBuffer('FavoriteHospitalsCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('address: $address, ')
          ..write('web: $web')
...
class $FavoriteHospitalsTable extends FavoriteHospitals
    with TableInfo<$FavoriteHospitalsTable, FavoriteHospital> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $FavoriteHospitalsTable(this.attachedDatabase, [this._alias]);
  final VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  ...
  late final GeneratedColumn<String?> web = GeneratedColumn<String?>(
      ...
      type: const StringType(), requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [id, name, address, web];
  @override
  String get aliasedName => _alias ?? 'favorite_hospitals';
  @override
  String get actualTableName => 'favorite_hospitals';
  @override
  VerificationContext validateIntegrity(Insertable<FavoriteHospital> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  FavoriteHospital map(Map<String, dynamic> data, {String? tablePrefix}) {
    return FavoriteHospital.fromData(data,
        prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }

  @override
  $FavoriteHospitalsTable createAlias(String alias) {
    return $FavoriteHospitalsTable(attachedDatabase, alias);
  }
}
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $FavoriteHospitalsTable favoriteHospitals =
      $FavoriteHospitalsTable(this);
  ...
  late final FavoriteHospitalsDao favoriteHospitalsDao =
      FavoriteHospitalsDao(this as AppDatabase);
  @override
  Iterable<TableInfo> get allTables => allSchemaEntities.whereType<TableInfo>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [users, calendarEvents, examinationQuestionnaires, favoriteHospitals];
}
