...
import '../ui/screens/hospital/find_hospital_screen.dart' as _i20;
...
class AppRouter extends _i16.RootStackRouter {
  ...
  final Map<String, _i16.PageFactory> pagesMap = {
    ...
    FindHospitalRoute.name: (routeData) {
      return _i16.MaterialPageX<void>(
          routeData: routeData, child: const _i20.FindHospitalScreen());
    },
              ...
              _i16.RouteConfig(PreAuthMainRoute.name,
                  ...
                  children: [
                    ...
                    _i16.RouteConfig(NoPermissionsRoute.name,
                        ...
                        parent: PreAuthMainRoute.name),
                    _i16.RouteConfig(FindHospitalRoute.name,
                        path: 'find-hospital', parent: PreAuthMainRoute.name),
        ...
        _i16.RouteConfig(MainScreenRouter.name, path: 'main', guards: [
          ...
          _i16.RouteConfig(MainRoute.name,
              ...
              children: [
                ...
                _i16.RouteConfig(FindHospitalRoute.name,
                    path: 'find-hospital', parent: MainRoute.name),
                _i16.RouteConfig(AboutHealthRoute.name,
...
/// generated route for
/// [_i20.FindHospitalScreen]
class FindHospitalRoute extends _i16.PageRouteInfo<void> {
  const FindHospitalRoute()
      : super(FindHospitalRoute.name, path: 'find-hospital');

  static const String name = 'FindHospitalRoute';
}
